...
\makecell[c]{\includegraphics[height=1.5cm]{thumbnails/sevd}} \\
\makecell[l]{\fitem{2}{Full list of the polyhedra that are made by edge-to-edge \\
	gluings of regular pentagons}} & &
\makecell[c]{\includegraphics[height=1.5cm]{thumbnails/penta}} \\
...
\makecell[c]{\includegraphics[height=1.5cm]{thumbnails/dncvd}}
